...
DataJson dataJsonFromJson(String str) => DataJson.fromJson(json.decode(str));

String dataJsonToJson(DataJson data) => json.encode(data.toJson());
...
class DataJson {
    ...
    factory DataJson.fromJson(Map<String, dynamic> json) => new DataJson(
